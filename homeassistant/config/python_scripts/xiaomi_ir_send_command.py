"""
Xiaomi IR Send Command Python Script for Home Assistant
...
logger.info(f"Sending IR command '{command}' to {device_ip}:{device_port}")
...
try:
    ...
    if command in ir_codes:
        ...
        try:
            ...
            logger.info("No response from device (this is normal for IR commands)")
    else:
